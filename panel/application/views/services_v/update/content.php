    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("services/update_form/$item->id"); ?>" method="post" enctype="multipart/form-data">
                   <div class="col-md-6 form-group"  style="margin-left: -9px;">
                    ...
                    <div class="col-md-3 form-group">
                        <label>İkon</label>
                        <input class="form-control" placeholder="İkon" name="ikon" value="<?php echo $item->ikon; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 image_upload_container">
                            <img src="<?php echo get_picture($viewFolder, $item->img_url, "770x435"); ?>" alt="" class="img-responsive">
                        </div>
