            ...
            <div class="widget-body">
                <form action="<?php echo base_url("slides/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Üst Başlık" name="altbaslik" value="<?php echo $item->altbaslik; ?>">
                        <?php if(isset($form_error)){ ?>
                            <small class="pull-right input-form-error"> <?php echo form_error("altbaslik"); ?></small>
                        <?php } ?>
                    </div>
                    <div class="form-group">
